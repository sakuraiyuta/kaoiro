 ...
 *  Registers three tools: `send_to_agent` (broker-gated via canUseTool),
 *  `list_agents` and `whoami` (auto-allow, read-only). ask_user_question
 *  is NOT registered here — Claude keeps its native tool (ADR-0032 F6). */
