...
- Related specs: [session capabilities](../reference/protocol/capabilities.md) (`ext.session_capabilities` field contract), [extensions](../architecture/extensions.md#session-capability-advertisement) (relationship with EngineAdapter).
