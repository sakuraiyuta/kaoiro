...
- Related specs: [protocol](../specs/protocol.md) (server injection into the spawn payload / control messages), [threat-model](../specs/threat-model.md) (spawn = RCE surface, operator-only), and [architecture](../architecture/system-overview.md).
