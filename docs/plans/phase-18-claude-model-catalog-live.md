...
- [x] Keep the relevant section (ADR-0037 reference section) of `docs/reference/engines/claude-model-catalog.md` updated with the finalized implementation
...
- Phase 18-2 Q1 verification detected 5 new extension fields in SDK-side
  ...
  **Of these, `resolvedModel` was resolved on 2026-07-31**—pass it transparently
  ...
  specification in [Claude model catalog](../reference/engines/claude-model-catalog.md)). The remaining 4
...
- Specs covered: [Claude model catalog](../reference/engines/claude-model-catalog.md), [protocol](../specs/protocol.md)
