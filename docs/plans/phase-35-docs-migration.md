...
| specs/setup-wizards.md (Purpose; Two wizards; Common policy) | [architecture/deployment.md](../architecture/deployment.md#setup-wizards) (new "## Setup wizards" section, 3 subsections verbatim) | U19b |
| specs/setup-wizards.md (Server env wizard; Runner configuration wizard; Out of scope; See Also) | [reference/configuration/setup-wizards.md](../reference/configuration/setup-wizards.md) (new page) | U19b |
