...
| 30 | [phase-30-history-restart-resilience](phase-30-history-restart-resilience.md) | 🟡 | 表示履歴の再起動耐性 — hydration handshake・IA sidecar による DETS 撤廃・projection epoch 再同期、[ADR-0051](../adr/0051-history-restart-resilience.md)(accepted、実装中) |
