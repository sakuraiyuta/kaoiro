...
| 30-3 | 既存文書 amendment sweep | もも | 🟡 | 委任済 2026-08-08。 ADR D8 の対象一覧: ADR-0014 A4 / ADR-0036 F3 / ADR-0030 D6 store 数 / protocol.md `preserve_inter_agent`・purge store 数 / deployment.md DETS 8 種 → 7 種 |
