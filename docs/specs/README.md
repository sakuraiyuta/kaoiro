...
| [Antigravity adapter architecture](../architecture/antigravity-adapter.md) | implemented | Current Antigravity adapter architecture; its event and permission contracts are in [reference](../reference/engines/antigravity-events.md) and dated CLI measurements are [evidence](../evidence/antigravity/cli-contract.md). |
