...
読んでいないので実害は出ていないが、ADR-0015 の規範には未達である。解消
するならサーバの relay 時 stamp が筋。
