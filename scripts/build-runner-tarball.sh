...
# issue #218: read the SAME build-info.json cli.ts itself reads at runtime
...
# (director's steer, issue #218 query round 2). The `<rev>[-dirty]` string
...
# different formats either (issue #218 round 2 MF-5, ふじ 差し戻し).
...
# bogus top-level entries (issue #144, found in #142's real-host
