...
// 4-4a/4-4b), plus session enumeration / resume (4-5). The thin cli.ts
// entry invokes this unconditionally so the runtime remains import-safe.
//
...
export function installRunnerUnhandledHandlers(): void {
