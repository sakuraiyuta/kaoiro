#!/usr/bin/env node
// Generates dist/build-info.json (issue #218, build identity) as the LAST
...
// same "mtime lies about provenance" failure mode issue #217's runbook
// documents, just for git state instead of a file timestamp; director's
// explicit steer, issue #218 query round 1).
//
...
// source of truth for revision/dirty, issue #218 query round 2) and
// formats its own version string via the SAME repo-level
// build-identity.mjs (`--format` mode, issue #218 round 2 MF-5).
